...
namespace Gadgeteer.Modules.IngenuityMicro
{
    ...
    public class RfPipe : GTM.Module
    {
        ...
        // GTM.IngenuityMicro.RfPipe. This file will provide IntelliSense and documentation for the
        // interface and make it easier for developers to use the RfPipe module.        

        // Note: A constructor summary is auto-generated by the doc builder.
        /// <summary></summary>
        /// <param name="socketNumber">The socket that this module is plugged in to.</param>
        /// <param name="socketNumberTwo">The second socket that this module is plugged in to.</param>
        public RfPipe(int socketNumber, int socketNumberTwo)
        {
        ...
        /// <summary>
        /// Gets a value that indicates whether the button of the RfPipe is pressed.
        /// </summary>
        ...
        /// <summary>
        /// Represents the state of button of the <see cref="RfPipe"/>.
        /// </summary>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="RfPipe"/> object that raised the event.</param>
        /// <param name="state">The state of the button of the <see cref="RfPipe"/></param>
        public delegate void ButtonEventHandler(RfPipe sender, ButtonState state);

        /// <summary>
        /// Raised when the button of the <see cref="RfPipe"/> is pressed.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Raised when the button of the <see cref="RfPipe"/> is released.
        /// </summary>
        /// <remarks>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="RfPipe"/> that raised the event.</param>
        /// <param name="buttonState">The state of the button.</param>
        protected virtual void OnButtonEvent(RfPipe sender, ButtonState buttonState)
        {
